...
export class MessagesComponent implements OnInit, OnDestroy {
  ...
  loadInboxMessages(): void {
    ...
    console.log('Component: Starting loadInboxMessages()');
    ...
    this.messageService
      ...
      .subscribe({
        next: (messages) => {
          console.log(
            'Component: Received messages from getInbox():',
            messages
          );
          this.messages = messages;
          console.log('Component: Updated this.messages array:', this.messages);
        },
        error: (error) => {
          console.error('Component: Error loading messages:', error);
